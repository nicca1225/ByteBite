<template>
  <div class="dashboard bg-black min-h-screen">
    <!-- ========== WELCOME SECTION ========== -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="relative overflow-hidden rounded-2xl border border-yellow-400/30 bg-gradient-to-r from-gray-900 to-black text-white p-8 shadow-lg">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-gray-900 p-6 rounded-xl shadow-lg border-l-4 border-yellow-400">
          ...
          <button
            ...
            class="w-full bg-yellow-400 hover:bg-yellow-300 text-black px-6 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            Plan Meals
          </button>
        </div>
